...
export default {
  ...
  methods: {
    ...
    rotateText() {
      let currentWord = this.wordsDom[this.currentWordIndex];
      let nextWord = this.currentWordIndex === this.maxWordIndex ? this.wordsDom[0] : this.wordsDom[this.currentWordIndex + 1];
