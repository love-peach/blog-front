<template>
  <div :class="prefixCls">
    <transition :name="mergedOption.transition">
      <div v-show="showing" :class="clazz" :id="mergedOption.id" :transition="mergedOption.transition">
        ...
        <a :class="`${prefixCls}-close`" v-if="mergedOption.closeable" @click="close()">&times;</a>
      </div>
    </transition>
  </div>
</template>
