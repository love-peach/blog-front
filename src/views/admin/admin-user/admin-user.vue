  ...
  <div>
    ...
    <Modal v-if="isShowUserModal" @close="handleHideUserModal">
      ...
      <div slot="body">
        ...
        <input class="common-input" v-model="formData.password" v-if="editMode === 'add'" type="password" placeholder="密码" />
        <input class="common-input" v-model="formData.confirmPassword" v-if="editMode === 'add'" type="password" placeholder="确认密码" />
        <input class="common-input" v-model="formData.password" v-if="editMode === 'edit'" type="password" placeholder="新密码" />
      </div>
      <div slot="footer">
