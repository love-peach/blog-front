<template>
  <div class="favorites-card">
    ...
    <router-link class="blog-poster" :to="{ path: `/blog/detail/${blogData._id}` }" :style="{ 'background-image': blogData.posterUrl ? 'url(' + blogData.posterUrl + ')' : '' }"></router-link>
    <div class="card-body">
    ...
    <div class="card-footer">
      <div class="blog-author">
        <div class="blog-author-avatar" :style="{ 'background-image': blogData.authorObj.avatar ? 'url(' + blogData.authorObj.avatar + ')' : '' }"></div>
